...
var NodisClient = (function () {
    function NodisClient(port, host) {
    ...
    NodisClient.prototype.cmd = function () {
        var args = [];
    ...
    NodisClient.prototype.on = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i - 0] = arguments[_i];
        }
    ...
    NodisClient.prototype.start = function () {
        this.tcp.start();
        return this;
    };
    return NodisClient;
}());
exports.NodisClient = NodisClient;
